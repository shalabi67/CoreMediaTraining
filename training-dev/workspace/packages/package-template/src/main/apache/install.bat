@ECHO OFF
REM First parameter is the application install root
...
SET MY_DIR=%~dp0
SET APPLICATION_INSTALL_ROOT_PARAM=%1
SET CONFIGURE_ROOT_PARAM=%2

IF DEFINED INSTALL_ROOT_PARAM (
  SET APPLICATION_INSTALL_ROOT=%APPLICATION_INSTALL_ROOT_PARAM%
) ELSE (
  SET APPLICATION_INSTALL_ROOT=C:\Apache2.2\conf.d
)
